...
# Memory: onchip_RAM_tp
MEM_0 := config_tp_onchip_RAM_tp
$(MEM_0)_NAME := onchip_RAM_tp
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_RAM_tp
$(MEM_0)_WIDTH := 32
...
.PHONY: onchip_RAM_tp
onchip_RAM_tp: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
