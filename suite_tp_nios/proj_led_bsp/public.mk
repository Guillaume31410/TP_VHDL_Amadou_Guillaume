...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../config_tp.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios_cpu_tp
CPU_NAME = nios_cpu_tp
...
# Design Name 
# setting SOPC_NAME is config_tp
SOPC_NAME := config_tp
...
# setting hal.stderr is jtag_uart_tp
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_tp

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_tp
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_tp
...
# setting hal.stdout is jtag_uart_tp
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_tp
